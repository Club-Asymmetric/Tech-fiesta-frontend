...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (user && !loading) {
      // Redirect to registration page if already logged in
          ...
          <div className="mt-6 text-center">
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
              <h3 className="text-white font-medium mb-2">
                Special Pricing for CIT Students
              </h3>
              <p className="text-sm text-gray-300">
                CIT students get special discounted pricing! Sign in with your
                @citchennai.net email to unlock exclusive rates.
              </p>
            </div>
          </div>
        </div>
