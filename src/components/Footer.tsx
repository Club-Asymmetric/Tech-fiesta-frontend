        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <p className="text-gray-300 text-base leading-relaxed mb-6 max-w-md">
              ...
              cutting-edge events, immersive workshops, and a vibrant
              community ecosystem.
            </p>
                ...
                <div className="p-2 bg-green-500/10 rounded-full group-hover:bg-green-500/20 transition-colors duration-300">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9-9a9 9 0 00-9 9m0 0a9 9 0 019-9"
                    />
                  </svg>
                </div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-400">
              <a href="/policy/terms" className="hover:text-white transition-colors">
                Terms & Conditions
              </a>
              <a href="/policy/privacy" className="hover:text-white transition-colors">
                Privacy Policy
              </a>
              <a href="/policy/refund" className="hover:text-white transition-colors">
                Refund Policy
              </a>
              <a href="/policy/shipping" className="hover:text-white transition-colors">
                Shipping Policy
              </a>
            </div>
          </div>
